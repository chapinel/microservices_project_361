    ...
    if(offOrOn === 'on') {
        return(
            ...
            <p className={styles.notifInfo}>
                If you have notifications turned on for a game, 
                we&apos;ll send you an email as soon as we know there&apos;s been an update!
            </p>
            <div className={styles.emailAddress}>
            <label>Email address</label>
            <input type="text" value={email} disabled></input>
            </div>
            <p className={styles.emailDefault}>
        ...
        return (
            <>
            <p className={styles.notifInfo}>
                Are you sure? If you turn off notifications, you will no longer receive email updates.
            </p>
